(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeComponent = /** @class */ (function () {
                ...
                HomeComponent.prototype.getUsers = function (ele) {
                    var _this = this;
                    this.user.searchForUser(ele.value).subscribe(function (res) {
                        if (res['status'] === 'done')
                            _this.users = res['data'];
                    });
                };
                HomeComponent.prototype.randomNumber = function () {
                    return Math.random().toString(16).slice(2, 8);
                };
                HomeComponent.prototype.openChat = function (_id) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                function LoginComponent(fb, user, flashMessage, router) {
                    this.fb = fb;
                    this.user = user;
                ...
                LoginComponent.prototype.ngOnInit = function () {
                    ...
                    this.loginForm.valueChanges.subscribe(function (_) { _this.getFormError(); });
                };
                ...
                LoginComponent.prototype.onSubmit = function () {
                    ...
                    this.user.loginOrSignupOrUpdateUser(this.loginForm.value, 'login').subscribe(function (res) {
                        if (res['status'] === 'done') {
                            _this.flashMessage.show("done : welcom", { cssClass: 'alert alert-success' });
                            localStorage.setItem('token', res['token']);
                            localStorage.setItem('userInfo', JSON.stringify(res['data']));
                            location.href = '/profile';
                        }
                        else {
                            _this.flashMessage.show(res['status'] + " : " + res['error'], { cssClass: 'alert alert-danger' });
                        }
                    }, function (err) {
                        _this.flashMessage.show(err.message, { cssClass: 'alert alert-danger' });
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MyValidation = /** @class */ (function () {
                ...
                MyValidation.email = function (controll) {
                    var res = /[a-zA-Z0-9_\.\-]+\@[a-zA-Z0-9_\-]{3,9}\.[a-zA-Z0-9_\-]{3,6}/.test(controll.value);
                    if (res) {
                        return null;
                    }
                    else {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProfileComponent = /** @class */ (function () {
                function ProfileComponent(user, flashMessage) {
                    this.user = user;
                    this.flashMessage = flashMessage;
                    this.userInfo = JSON.parse(localStorage.getItem('userInfo'));
                    this.profile = false;
                ...
                ProfileComponent.prototype.togglecoverOption = function () {
                    this.cover = !this.cover;
                };
                ProfileComponent.prototype.toggleProfileOption = function () {
                    this.profile = !this.profile;
                };
                ProfileComponent.prototype.coverChange = function (event) {
                ...
                ProfileComponent.prototype.uploadFile = function () {
                    var _this = this;
                    this.user.uploadFile(this.data).subscribe(function (res) {
                        if (res['body']) {
                            res = res['body'];
                            if (res['status'] === 'done') {
                                _this.flashMessage.show(res['status'], { cssClass: 'alert-success' });
                                _this.userInfo[res['data'].field] = res['data'].name;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SignupComponent = /** @class */ (function () {
                function SignupComponent(fb, user, flashMessage, router, route) {
                    this.fb = fb;
                    this.user = user;
                    this.flashMessage = flashMessage;
                    this.router = router;
                ...
                SignupComponent.prototype.ngOnInit = function () {
                    ...
                    this.signupForm.valueChanges.subscribe(function (_) { _this.getFormError(); });
                ...
                SignupComponent.prototype.onSubmit = function () {
                    ...
                    console.log(data);
                    this.user.loginOrSignupOrUpdateUser(data, this.pageCase).subscribe(function (res) {
                        if (res['status'] === 'done') {
                            if (_this.pageCase === 'signup') {
                                _this.flashMessage.show("done : You can login now", { cssClass: 'alert alert-success' });
                                _this.router.navigate(['/login']);
                            }
                            else {
                                _this.flashMessage.show("done", { cssClass: 'alert alert-success' });
                                _this.userInfo['firstname'] = _this.signupForm.get('firstname').value;
                                _this.userInfo['lastname'] = _this.signupForm.get('lastname').value;
                                _this.userInfo['email'] = _this.signupForm.get('email').value;
                                localStorage.setItem('userInfo', JSON.stringify(_this.userInfo));
                            }
                        }
                        else {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserService = /** @class */ (function () {
                ...
                UserService.prototype.searchForUser = function (name) {
                    var token = this.jwt.getToken();
